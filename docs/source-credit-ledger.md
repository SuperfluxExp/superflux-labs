...
| Kandarp Jani — *How to write your way to problem solving?* / Recursive Thought Writing (March 2023) | [`write-through-problems`](../skills/write-through-problems/SKILL.md) | Original author-owned process, published with explicit permission. The skill preserves capture → organize → subproblem islands → diffusion → recursion/socialization and labels the agent-specific safeguards as adaptations. The original presentation is not included. |
